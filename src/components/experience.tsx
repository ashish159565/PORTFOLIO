...
const collegeClubExperiences: Experience[] = [
  {
...
export function Experience() {
  ...
  const [expandedCollegeIndex, setExpandedCollegeIndex] = useState<
    number | null
  >(null);
  ...
  const renderExperienceSection = (
    ...
    <div className="space-y-4 relative">
      ...
      {/* Timeline line */}
      <div className="absolute left-6 top-16 bottom-0 w-0.5 bg-gradient-to-b from-accent via-accent/50 to-transparent hidden sm:block" />
  ...
  return (
    <section id="experience" className="container mx-auto px-4 py-20 max-w-4xl">
      <div className="space-y-8">
        ...
        {/* College Clubs */}
        {renderExperienceSection(
          "College Clubs & Community",
          collegeClubExperiences,
          expandedCollegeIndex,
          setExpandedCollegeIndex,
        )}
      </div>
    </section>
  );
